...
public abstract class LiveBaseActivity extends BaseActivity {
      ...
      if (PreferenceManager.getInstance().getPayMentTip()){
        ...
        cb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
          ...
          public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
              PreferenceManager.getInstance().setSharedPaymentTip(isChecked);
          }
        });
  ...
  private void sendGift(final RoomGiftListsDialog dialog,final Gift gift){
    ...
    if (change>=gift.getGprice()){
      ...
      builder.setNeutralButton("充值", new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface d, int which) {
