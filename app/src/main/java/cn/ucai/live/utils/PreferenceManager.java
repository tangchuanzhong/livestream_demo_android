...
public class PreferenceManager {
	...
	private static String SHARED_PAYMENT_TIP = "SHARED_PAYMENT_TIP";
	...
	public void setSharedPaymentTip(boolean tip) {
		editor.putBoolean(SHARED_PAYMENT_TIP, tip);
		editor.apply();
	}

	public Boolean getSharedPaymentTip() {
		return mSharedPreferences.getBoolean(SHARED_PAYMENT_TIP, false);
	}
	...
	public void removeCurrentUserInfo() {
		...
		editor.remove(SHARED_PAYMENT_TIP);
